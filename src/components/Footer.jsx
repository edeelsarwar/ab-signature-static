...
/**
 * Footer component with links, categories, and social media
 * Displays company info and navigation links
 */
const Footer = () => {
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">AB-Signature</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Premium unstitched fabrics for the discerning customer. Quality, elegance, and tradition in every piece.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop" className="hover:text-primary-400 transition-colors text-sm">
                  Shop
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/order-history" className="hover:text-primary-400 transition-colors text-sm">
                  Order History
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-3">
                ...
                <span>123 Fabric Street, Karachi, Pakistan</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>info@ab-signature.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>&copy; {currentYear} AB-Signature. All rights reserved.</p>
          <p className="mt-2 text-gray-500">
            Crafted with care for fabric enthusiasts everywhere
          </p>
        </div>
      </div>
    </footer>
